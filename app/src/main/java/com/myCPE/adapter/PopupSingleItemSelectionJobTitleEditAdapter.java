...
public class PopupSingleItemSelectionJobTitleEditAdapter extends RecyclerView.Adapter {
...
//    public PopupSingleItemSelectionJobTitleEditAdapter(Context mContext, List<CityItem> mListNew) {
    public PopupSingleItemSelectionJobTitleEditAdapter(Context mContext, List<JobTitleItem> mListNew) {
