...
public class PopupSingleItemSelectionCityEditAdapter extends RecyclerView.Adapter {
...
//    public PopupSingleItemSelectionAdapter(Context mContext, List<com.myCPE.model.homewebinarnew.WebinarItem> mList) {
    public PopupSingleItemSelectionCityEditAdapter(Context mContext, List<CityItem> mListNew) {
