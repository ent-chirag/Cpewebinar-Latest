...
public class ProffesionalCredentialEditPopUpAdapter extends RecyclerView.Adapter<ProffesionalCredentialEditPopUpAdapter.ViewHolder> {
    ...
    public ProffesionalCredentialEditPopUpAdapter(Context mContext, ArrayList<Model_proffesional_Credential> mList) {
