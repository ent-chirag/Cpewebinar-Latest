...
import com.myCPE.R;
import com.myCPE.adapter.SignUpInterestAdapter;
import com.myCPE.model.topicsofinterestn.TagsItem;
import com.myCPE.model.topicsofinterestn.TopicOfInterestsItem;
...
public class TopicsofInterestSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.myCPE.R.layout.activity_signup_topicsofinterest);
        ...
        if (Constant.isNetworkAvailable(context)) {
            progressDialog = DialogsUtils.showProgressDialog(context, getResources().getString(com.myCPE.R.string.progrees_msg));
            GetTopicsofInterest();
        } else {
            Snackbar.make(tv_submit, getResources().getString(com.myCPE.R.string.please_check_internet_condition), Snackbar.LENGTH_SHORT).show();
        }
   ...
   /* public void RegisterPost(String first_name, String last_name, String email, String password, String confirm_password,
    ...
    private void init() {
        ivback = (ImageView) findViewById(com.myCPE.R.id.ivback);
        rvtopics_of_interest = (RecyclerView) findViewById(R.id.rvtopics_of_interest);
        tv_submit = (TextView) findViewById(com.myCPE.R.id.tv_register);
        edt_search = (EditText) findViewById(R.id.edt_search);
    }

    public void GetTopicsofInterest() {
        mAPIService.GetTopicsofInterestsSignUp(getResources().getString(com.myCPE.R.string.accept)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
