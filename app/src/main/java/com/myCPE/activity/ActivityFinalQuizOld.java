...
public class ActivityFinalQuizOld extends AppCompatActivity {
    ...
    private static ActivityFinalQuizOld instance;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context = ActivityFinalQuizOld.this;
        mAPIService = ApiUtilsNew.getAPIService();
        instance = ActivityFinalQuizOld.this;
...
//                            Snackbar.make(binding.ivback, finalQuizAnswer.getMessage(), Snackbar.LENGTH_SHORT).show();
    ...
    public static ActivityFinalQuizOld getInstance() {
        return instance;
