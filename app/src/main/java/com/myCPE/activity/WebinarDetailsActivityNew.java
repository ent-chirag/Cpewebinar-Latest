...
//    ActivityWebinardetailsBinding binding;
    ActivityWebinardetailsNew1Binding binding;
    private APIService mAPIService;
    ProgressDialog progressDialog;
    private static final String TAG = WebinarDetailsActivityNew.class.getName();
    ...
    private static WebinarDetailsActivityNew instance;
...
//        binding = DataBindingUtil.setContentView(this, R.layout.activity_webinardetails);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_webinardetails_new_1);
        context = WebinarDetailsActivityNew.this;
        instance = WebinarDetailsActivityNew.this;
...
//                Intent i = new Intent(context, ActivityReviewQuestion.class);
        ...
        binding.ivnotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WebinarDetailsActivityNew.this, NotificationActivity.class);
                startActivity(i);
...
//                        builder.setPositiveButton("OK", null);
    ...
    private void showAddReviewPopUp() {
        ...
        tv_title.setText(getResources().getString(R.string.str_title_question_rating_popup) + " " + WebinarDetailsActivityNew.getInstance().aboutpresenterCompanyName + "?");
...
//                        GetSubmitAnswer(questionsParams, ansParams, "" + percentage);
    ...
    public static WebinarDetailsActivityNew getInstance() {
        return instance;
    ...
    public void ShowPopupAddtoCalender(String webinar_titile) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(WebinarDetailsActivityNew.this);
    ...
    private void closeFullscreenDialog() {
        ...
        mFullScreenIcon.setImageDrawable(ContextCompat.getDrawable(WebinarDetailsActivityNew.this, R.drawable.ic_fullscreen_expand));
    }
    ...
    private void openFullscreenDialog() {
        ...
        mFullScreenIcon.setImageDrawable(ContextCompat.getDrawable(WebinarDetailsActivityNew.this, R.drawable.ic_fullscreen_skrink));
...
//                webinar_status.equalsIgnoreCase(getResources().getString(R.string.str_webinar_status_resume_watching))){
    ...
    public void onBackPressed() {
        ...
        if (mExoPlayerFullscreen) {
            ...
            Intent i = new Intent(WebinarDetailsActivityNew.this, MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
