...
public class CertificatesListWebinarDetailsPopUpAdapter extends RecyclerView.Adapter<CertificatesListWebinarDetailsPopUpAdapter.ViewHolder> {
    ...
    public CertificatesListWebinarDetailsPopUpAdapter(Context mContext, List<MyCertificateLinksItem> mList) {
